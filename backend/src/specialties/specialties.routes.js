...
router.put('/:id', specialtyController.updateSpecialty.bind(specialtyController));
router.delete('/:id', specialtyController.deleteSpecialty.bind(specialtyController));
router.get('/category/:categoryId', specialtyController.getSpecialtiesByCateogryId.bind(specialtyController));
